 ...
 *
 * <p>This is the app shell (FS-001): a runnable Spring Boot 3 / Java 21 service exposing a
 * public health endpoint, fail-fast environment validation, Flyway migration tooling, and a
