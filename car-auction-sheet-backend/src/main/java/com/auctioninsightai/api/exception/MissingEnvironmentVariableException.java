 ...
 *
 * <p>The message always names the missing variable so the failure is actionable at the point the
 * application refuses to start (FS-001 AC: fail fast with a named-variable error).
 */
public class MissingEnvironmentVariableException extends RuntimeException {
  ...
  /**
   * Creates the exception for a specific missing variable.
   *
   * @param variableName the name of the environment variable that is missing or blank
   */
